<template>
    <div v-if="appliedFilters" @click="clearFilters" class="px-1 me-0 mb-1 mb-xxl-0 me-xxl-3 cursor-pointer border border-danger rounded-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Очистить фильтр">
