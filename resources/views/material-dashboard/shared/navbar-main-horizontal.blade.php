<!-- Navbar -->
<nav class="navbar navbar-main navbar-expand-lg position-sticky top-1 p-0 mx-4 mb-2 shadow-none border-radius-xl z-index-sticky" id="navbarBlur" data-scroll="true">
