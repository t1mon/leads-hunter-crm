...
@php
    $journal_fields = ['id', 'phone', 'entries', 'class_id', 'comment_crm', 'owner', 'company', 'nextcall_date', 'email', 'city', 'manual_city', 'region', 'manual_region', 'cost', 'host', 'referrer', 'utm_source', 'utm_medium', 'utm_campaign', 'source'];
@endphp
