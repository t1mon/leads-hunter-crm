    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row justify-content-center mb-2">
                ...
                {{--URL API-метода для получения access_token--}}
                <div class="col-4 text-center">
                    {!! Form::label('access_token', 'URL API-метода для получения access_token', ['class' => 'form-label']) !!}
                    <div class="border rounded-3 p-1">
                        {!! Form::text('auth_url', $webhook->auth_url ?? null,
                            [
                                'class' => 'form-control',
                                'placeholder' => 'URL API-метода для получения access_token',
                                'id' => 'access_token'
                            ])
                        !!}
                    </div>
