...
return [
    ...
    //Flash-сообщения
    'not-authorized' => 'У вас нет полномочий на просмотр данной страницы',
    ...
    'users' => [
        ...
        'hints' => [
            'make_admin' => 'Сделать администратором',
            'manage_users' => 'Разрешить добавлять и удалять пользователей в проект',
            'manage_settings' => 'Разрешить управление настройками проекта',
            'manage_payments' => 'Разрешить осуществлять оплату',
            'view_journal' => 'Разрешить просмотр журнала',
